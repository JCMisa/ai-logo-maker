            ...
            <div className="flex flex-wrap">
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-6 grow">
                    ...
                    <p className="text-[#76828D] ">jcmisa.dev@gmail.com</p>
                    <p className="text-[#76828D] ">+63 907 181 6666</p>
                  </div>
                </div>
              </div>
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
              ...
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                <div className="align-start flex">
                  ...
                  <div className="ml-6 grow">
                    <p className="mb-2 text-[#E8E9E9] ">Academic</p>
                    <p className="text-[#76828D] ">0322-1946@lspu.edu.ph</p>
                    <p className="text-[#76828D] ">+63 907 181 6666</p>
                  </div>
                </div>
              </div>
